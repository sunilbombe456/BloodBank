...
<div style="height:530px; width:700px; margin:auto; margin-top:10px; margin-bottom:10px; background-color:rgba(255,0,0,0.1); border:2px solid red; box-shadow:4px 1px 20px black;">
...
<tr><td>&nbsp;</td><td><input type="submit" value="Register" name="sbmt" style="border:0px; background:linear-gradient(rgba(255,0,0,0.8),red); width:100px; height:30px; border-radius:1.5rem; color:white; font-weight:bold; font-size:14px; text-shadow:1px 1px 6px black; "></td></tr></table>
</td></tr>
</table>
</form>
        </div>
